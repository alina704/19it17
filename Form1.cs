...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        {
            FileStream file = new FileStream("C:\\wwod.txt", FileMode.OpenOrCreate, FileAccess.Write);
            StreamWriter writer = new StreamWriter(file);
            writer.Write("Исходная единица измерения количества инфрмации" + tb11.Text); //записываем в файл
            writer.Close();
        }

        private void textBox2_TextChanged_1(object sender, EventArgs e)
        {// Вывод исходных данных
            FileStream file = new FileStream("C:\\wiwod.txt", FileMode.OpenOrCreate, FileAccess.Read);
            StreamReader reader = new StreamReader(file);
            tb12.Text = reader.ReadToEnd();
            reader.Close();
